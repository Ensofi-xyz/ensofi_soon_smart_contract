...
use crate::{
  common::{
      ...
      event::LiquidatingCollateralEvent
  },
  states::{LoanOfferAccount, Asset, VaultAuthority, PriceFeedAccount},
...
pub struct StartLiquidateLoanOfferHealth<'info> {
  ...
  pub hot_wallet_ata_collateral_asset: InterfaceAccount<'info, InterfaceTokenAccount>,
  #[account(
    mut,
