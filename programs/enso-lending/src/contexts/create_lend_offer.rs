...
use crate::{
    common::{
        constant::{
            ...
            LendOfferStatus,
            DISCRIMINATOR,
            MAX_ALLOWED_INTEREST
        },
        error::LendOfferError,
        event::CreateLendOfferEvent
    },
    states::{Asset, LendOfferAccount, SettingAccount}
};
...
pub struct CreateLendOffer<'info> {
    ...
    pub hot_wallet_ata: InterfaceAccount<'info, InterfaceTokenAccount>,
