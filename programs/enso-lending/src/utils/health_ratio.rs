...
use crate::{LoanOfferError, PriceFeedAccount, MIN_BORROW_HEALTH_RATIO};

// use super::convert_to_usd_price;
use crate::pyth::convert_to_usd_price_v1;

pub struct HealthRatioParams<'a> {
    // pub collateral_price_feed_account: &'a PriceUpdateV2,
    pub collateral_price_feed_account: &'a PriceFeedAccount,
    ...
    pub lend_price_feed_account: &'a PriceFeedAccount,
    pub lend_amount: u64,
...
pub fn get_health_ratio_and_assets_price(params: HealthRatioParams) -> (f64, f64, f64) {
    ...
    let (convert_collateral_amount_to_usd, collateral_price) = convert_to_usd_price_v1(
        collateral_price_feed_account,
        &collateral_price_feed_id,
    ...
    let (convert_lend_amount_to_usd, lend_price) = convert_to_usd_price_v1(
        lend_price_feed_account,
        &lend_price_feed_id,
